...
$client = new KClient('https://hindupujaonline.com/', 'WSJdBNRwbmhnQxmH');
			...
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<header>
								<h1>This is Phantom<br />
								English scholl by KZ <a href=""></a>.</h1>
								<p>Start speaking English within a month.</p>
							</header>
							<section class="tiles">
